package fr.dashboard.hosts.domain.model;
...
public class Eater implements Serializable
{
    ...
    /**
     * Position to make Hosts. Low position have to do it FIRST !
     */
    @Column(nullable = false)
    private Integer position;

    /**
     * Last time the update have been performed for that user (last hosts commit)
     */

package fr.dashboard.hosts.web.services.exceptionHandler;
 ...
 * @author ystreibel
 */
public class DashboardHostsRequestExceptionHandler implements RequestExceptionHandler
{
    /**
     * Logger
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(DashboardHostsRequestExceptionHandler.class);
     ...
     */
    public DashboardHostsRequestExceptionHandler(ExceptionHandlerService exceptionService, ComponentSource componentSource, ResponseRenderer renderer,

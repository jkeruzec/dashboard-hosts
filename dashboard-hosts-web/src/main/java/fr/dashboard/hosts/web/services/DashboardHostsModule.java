...
import fr.dashboard.hosts.common.constants.BuildProfilesEnum;
import fr.dashboard.hosts.web.services.exceptionHandler.ExceptionHandlerService;
import fr.dashboard.hosts.web.services.exceptionHandler.DashboardHostsRequestExceptionHandler;
...
public class DashboardHostsModule
{

    public static void bind(ServiceBinder binder)
    {
        binder.bind(ApplicationListener.class).eagerLoad();
        binder.bind(DashboardHostsApplicationScope.class);
    ...
    {
        return new DashboardHostsRequestExceptionHandler(exceptionService, componentSource, renderer, request, productionMode);
    }

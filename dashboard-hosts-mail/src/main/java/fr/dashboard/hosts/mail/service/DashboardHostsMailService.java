...
public interface DashboardHostsMailService
{
     ...
     * @param teamName the name of the team requesting the hosts
     */
    void sendHostsRequest(List<String> emails, String cc, String teamName, String customMsg) throws MessagingException;

    /**
     * Send a call for Hosts mail to all the team
     * 
     * @param emails the emails to warn
     * @param cc the carbon copy recipient, i.e le manager of the team
     * @param teamName the name of the team calling for hosts
     * @param customMsg a custom message to add to the mail
     * @throws MessagingException si le mail ne peut etre envoyé
     */
    void callTeamForHosts(List<String> emails, String teamName, String customMsg) throws MessagingException;
}

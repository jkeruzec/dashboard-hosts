package fr.dashboard.hosts.mail.service;
...
public class DashboardHostsMailServiceTest extends UnitilsTestNG
{

    private static final String MAIL_TEST_FROM = "noreply@dashboard-hosts.fr";

    private static final String MAIL_TEST_SUBJECT = "Test";

    private static final String MAIL_TEST_TO = "test@dashboard-hosts.fr";

    /**
     * Logger
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(DashboardHostsMailServiceTest.class);

    /**
     * Service de gestion des utilisateurs a tester
     */
    @SpringBean("dashboard-hostsMailService")
    ...
    /**
     * Test method for
     * {@link fr.dashboard.hosts.mail.service.DashboardHostsMailService#sendEmail(java.lang.String, java.lang.String, java.lang.String, java.lang.String)}
     * .
     */
    @Test
    ...
    @Test
    public void testSendCallTeamForHosts()
    {
        Assert.assertEquals(0, smtpServer.getReceivedEmailSize());
        ...
        try
        {
            mailService.callTeamForHosts(emails, "Agefos", null);
        }
        catch (MessagingException e)
        {
            LOGGER.error("Pb lors du préparation ou de l'envoi du mail: " + e);
    ...
    @Test
    public void testSendCallTeamForHostsWithCustomMessage()
    {
        Assert.assertEquals(0, smtpServer.getReceivedEmailSize());
        List<String> emails = new ArrayList<String>();
        emails.add(MAIL_TEST_TO);
        ...
        try
        {
            mailService.callTeamForHosts(emails, "Agefos", customMsg);
        }
        catch (MessagingException e)
        {
            LOGGER.error("Pb lors du préparation ou de l'envoi du mail: " + e);
    ...
    @Test
    public void testSendHostsRequestWithCustomMessage()
    {
        Assert.assertEquals(0, smtpServer.getReceivedEmailSize());
        List<String> emails = new ArrayList<String>();
        emails.add(MAIL_TEST_TO);
        ...
        try
        {
            mailService.sendHostsRequest(emails, MAIL_TEST_FROM, "Agefos", customMsg);
        }
        catch (MessagingException e)
        {
            LOGGER.error("Pb lors du préparation ou de l'envoi du mail: " + e);
    ...
    private Map<String, String> getTemplateModel()
    {
        ...
        String name = "dashboard-hosts";
        String text = "Mail de l'application DashboardHosts";
        model.put("name", name);
        model.put("text", text);
        return model;
    }
